...
## Phase 2: Growth and Engagement (3-6 months)
...
Santulan is a mobile app that makes sustainability fun and impactful through gamified challenges, real-world action, and a supportive community. We empower young people to learn, act, and make a difference for a greener future.
...
- Gamified challenges: Users can participate in a variety of challenges that are designed to be fun and engaging. These challenges can be related to different SDGs, and they can help users learn about sustainability and take action in their own lives.
- Real-world action: Santulan is not just about playing games. The app also connects users to real-world opportunities to take action on sustainability. For example, users can plant trees, clean up their communities, and reduce their carbon footprint.
- Supportive community: Santulan has a built-in community where users can connect with each other, share their experiences, and support each other in their sustainability journeys. 
- Educational content: Santulan offers a variety of educational content that can help users learn more about sustainability. This content includes articles, videos, and quizzes. 
- Skill Share Community: NGOs and organizations post projects seeking youth support, enabling users to lend skills, learn new ones, and earn certificates. 
